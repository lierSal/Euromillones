package euromillones.ateneasystems.es.euromillones.SeekBarPersonalizado;
...
/**
 * Created by cubel on 11/03/15.
 */
public class SeekBarOpciones extends Preference implements OnSeekBarChangeListener {


    private final String TAG = getClass().getName();

    private static final String ANDROIDNS = "http://schemas.android.com/apk/res/android";
    private static final String APPLICATIONNS = "http://ateneasystems.es";
    ...
    public SeekBarOpciones(Context context, AttributeSet attrs) {
        super(context, attrs);
        initPreference(context, attrs);
    }

    public SeekBarOpciones(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void initPreference(Context context, AttributeSet attrs) {
        ...
        setWidgetLayoutResource(R.layout.seekbar_item_opci);
    }
